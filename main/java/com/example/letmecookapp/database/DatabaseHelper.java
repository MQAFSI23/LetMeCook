package com.example.letmecookapp.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "letmecookapp_favorites.db";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(String.format("DROP TABLE IF EXISTS %s, %s", TABLE_FAVORITES, TABLE_INVENTORY));
        onCreate(db);
    }
